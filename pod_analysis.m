...
save('output/subspace_residuals.mat', 'cyl_res', 'sst_res', 'gom_res'...
    , 'm_cyl', 'm_sst', 'm_gom', 'm_mix', 'mix_res', 'window_res')
disp('Done')
